...
let cMODE : mode = Travel

(* For Quarantine *)
(* Probability of being put into quarantine if you infected *)
let cQUARANTINE = 0.02 ;;

(* For Grocery *)
(* Probability to go to the grocery *)
let cGROCERY = 0.01 ;;

(* For Travel - WORKS FINE *)
(* Probability to go travel to some random location *)
let cTRAVEL = 0.01 ;;
